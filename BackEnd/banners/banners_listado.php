...
<html>
	<head>
		...
		<script>
			...
			function editar(id_){
				window.location.href='banners_update.php?id='+id_;
			}
	...
	<body style="background-color:#F0F8FF;">
		<div id="titulo">
		<h1 align="center">Listado de Banners</h1>
		<h2 align="center">Ingresar un nuevo registro: <input type="button" onClick="window.location.href = 'banners_alta.php'" value="Nuevo Registro"></h2>
		</div>
		<table id="tabla">
			<tr>
