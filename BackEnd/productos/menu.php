...
<html>
	...
	<body style="background-color:#F0F8FF;">
		<div id="encabezado_menu">
			<div id="titulo_menu"><h1>Administradores</h1></div>
		...
		<table id="barra_menu">
			<tr>
				...
				<td class="columna_menu"><a href = "productos_listado.php">Productos</a></td>
				<td class="columna_menu"><a href="../banners/banners_listado.php">Banners</a></td>
				<td class="columna_menu"><a href="../pedidos/pedidos_listado.php">Pedidos</a></td>
