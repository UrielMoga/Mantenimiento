...
class ControladorUsuarios {
        ...
        if (isset($_POST["regUsuario"])) {
            ...
            if (preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
                ...
                if ($respuesta == "ok") {
                    ...
                    $mail->setFrom('contacto@comersi.club', 'MiComersi');

                    $mail->addReplyTo('contacto@comersi.club', 'MiComersi');
                    ...
                    $mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
						...
						<center>
							...
							<img style="padding:20px; width:10%" src="http://comersi.club/img/noticias/comersiProtoColor.png">
    ...
    static public function ctrRegistroRedesSociales($datos) {
        ...
        if ($emailRepetido || $respuesta1 == "ok") {
            ...
            if ($respuesta2["modo"] == "facebook") {
                ...
                $_SESSION["validarSesion"] = "ok";
                $_SESSION["idClienteS"] = $respuesta2["idClienteS"];
    ...
    public function ctrActualizarPerfil() {
        ...
        if (isset($_POST["editarNombre"])) {
            ...
            if ($respuesta == "ok") {
                ...
                $_SESSION["validarSesion"] = "ok";
                $_SESSION["idClienteS"] = $datos["idClienteS"];
        ...
        if (isset($_POST["idComentario"])) {
            ...
            if (preg_match('/^[,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["comentario"])) {
                ...
                if ($_POST["comentario"] != "") {
                    ...
                    $datos = array("idClienteS" => $_POST["idComentario"],
    ...
    public function ctrEliminarUsuario() {
        ...
        if (isset($_GET["id"])) {
            ...
            if ($_GET["foto"] != "") {
                ...
                unlink($_GET["foto"]);
                rmdir('vistas/img/usuarios/' . $_GET["idClienteS"]);
            }
    ...
    static public function ctrAgregarConsulta() {
    ...
    public function ctrFormularioContactenos() {
        ...
        if (isset($_POST['mensajeContactenos'])) {
            ...
            if (preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nombreContactenos"]) &&
                ...
                $mail->addAddress("contacto@comersi.club");

                $mail->msgHTML('

						<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">

						<center><img style="padding:20px; width:10%" src="http://comersi.club/img/noticias/comersiProtoColor.png"></center>
                ...
                $envio = $mail->Send();
                $tabla = "consulta";
                $nombre = $_POST["nombreContactenos"];
                $correo = $_POST["emailContactenos"];
                $consulta = $_POST["mensajeContactenos"];

                $respuesta = ModeloUsuarios::mdlIngresoConsulta($tabla, $nombre, $correo, $consulta);
